...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-2 m-0 ml-4 container-fluid">
            ...
            <button type="button" class="btn btn-outline-light" data-html="true" data-toggle="popover" title="UPDATED" data-content=" UPDATED">
                    Update Records
                </button>
        </div>
        <div class="col-9 container-fluid p-2 pr-3">
            <h2>Dashboard:</h2>
            <div class="row ">
                <div class="col-4">
